...
Define the canonical data model for assets, ensure data integrity (specifically serial number uniqueness and monetary precision), and provide API endpoints for managing and retrieving assets and their associated documents.
