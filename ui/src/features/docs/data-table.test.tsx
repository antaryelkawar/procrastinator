 ...
 * interaction). The menu-driven tests below therefore carry a generous 60s
 * timeout with headroom over that runtime so they stay green under full-suite
 * parallel load (a tighter 20s boundary flaked randomly across runs).
 */
