...
// Extractor adapts the LLM Client to the repo.Extractor interface for
// document extraction.
type Extractor struct {
	client *Client
}

// Compile-time guard: Extractor must satisfy repo.Extractor.
var _ repo.Extractor = (*Extractor)(nil)
